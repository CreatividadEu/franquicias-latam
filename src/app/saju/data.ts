...
export const SAJU = {
  ...
  ideal: {
    ...
    body: "Sajú arrancó hace más de 8 años como un chiste universitario: cuelga-gafas vendidos en una caja de zapatos. Hoy somos una de las marcas de eyewear más relevantes de Colombia. Esa es la vida que se vive tachando — y la lista apenas empieza.",
    checklist: [
      ...
      { label: "Franquicia Master en LATAM", done: false },
  ...
  product: {
    ...
    lensesBar: {
      title: "Lenses Bar",
      body: "Lentes formulados en 20 minutos, que resuelven el 80% del Pareto de clientes ópticos.",
    },
    stats: [
      { value: "~$110", label: "Ticket promedio (4× desde el inicio)" },
      { value: "20 min", label: "Lentes formulados en el Lenses Bar" },
      { value: "80%", label: "del Pareto de clientes ópticos" },
  ...
  opportunity: {
    ...
    special: "Estados Unidos y México son casos especiales — no son foco en esta primera ola.",
    stats: [
  ...
  deal: {
    ...
    rows: [
      {
        k: "Fee de entrada",
        v: "Desde $100.000 USD",
        note: "Por territorio estándar, sin límite de tiendas. USA y México son casos especiales.",
      },
      {
        k: "Royalties",
        v: "7% → 4%",
        note: "Arrancan en 7% sobre ventas y bajan progresivamente al 5%–4% al alcanzar el objetivo de tiendas.",
      },
      {
    ...
    profile: {
      ...
      proof: "Nuestros masters actuales: Giuliano en Costa Rica (fundador de The Yard, +10 sucursales) y un grupo restaurantero en Venezuela (Trinchero Burgers, Vessubio).",
    },
  },
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Royalties: arrancan en 7% sobre ventas y bajan progresivamente al 5%–4% a medida que el franquiciado alcanza el objetivo de tiendas del territorio. Fondo de publicidad: 3%.",
    },
    {
    ...
    },
    {
      ...
      a: "Empresarios o emprendedores con experiencia construyendo negocios, capital para inversión y red local relevante. Idealmente alguien que entienda muy bien su mercado local — eventos, influenciadores, lugares y marcas en tendencia. Nuestros masters actuales son perfiles de este tipo: en Costa Rica, Giuliano fundó The Yard (+10 sucursales); en Venezuela, el grupo opera Pilar y Juanito, Trinchero Burgers y Vessubio.",
    },
    {
